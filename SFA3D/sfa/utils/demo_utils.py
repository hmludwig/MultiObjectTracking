...
from utils.evaluation_utils import decode, post_processing, post_processing2
...
def do_detect(configs, model, bevmap, is_front):
    ...
    precious = detections.copy()
    precious = post_processing2(precious, configs.num_classes, configs.down_ratio, configs.peak_thresh)
    detections = post_processing(detections, configs.num_classes, configs.down_ratio, configs.peak_thresh)
    t2 = time_synchronized()
    # Inference speed
    fps = 1 / (t2 - t1)

    return detections[0], bevmap, fps, precious
